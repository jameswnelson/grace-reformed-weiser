  ...
  const mockEvents: CalendarEvent[] = [
    {
      ...
      start: new Date('2025-09-14T11:00:00'),
      end: new Date('2025-09-14T13:00:00'),
    ...
    {
      id: '3',
      title: 'After Church Potluck',
      description: 'Sunday potluck lunch',
      start: new Date('2025-09-14T13:00:00'),
      end: new Date('2025-09-14T15:30:00'),
      location: 'Grace Reformed Church of Weiser',
      category: 'fellowship',
      recurring: true,
    },
    {
      id: '2',
      title: 'Psalm Sing',
      description: 'Thursday psalm sing',
      start: new Date('2025-09-11T19:00:00'),
      end: new Date('2025-09-11T20:30:00'),
      location: 'Grace Reformed Church of Weiser',
      category: 'study',
      recurring: true,
    },
